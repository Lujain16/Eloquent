...
public class Scenarios extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        outputFile = Environment.getExternalStorageDirectory().getAbsolutePath()+ "/Scenarios_Recording.mp3";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =new Intent(Scenarios.this, StutteringSeverity.class);// change StutteringSeverity.class ****
