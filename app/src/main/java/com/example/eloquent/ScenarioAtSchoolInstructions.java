...
public class ScenarioAtSchoolInstructions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scenario_at_school_instructions);

        //start button
        //when user click on start button  this code will move them to the ScenariosAtSchool page
